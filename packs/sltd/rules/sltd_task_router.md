...
readiness: source_surface_check -> scene_first_prose_judgment if prose readiness is being inferred from checklist compliance -> anti_ai_composite_check if false readiness risk appears -> publishing_readiness_reviewer -> chapter_readiness_check -> sltd_publishing_readiness -> node_checkpoint
```
