...
START WHEN a claim is true/false/current/canon/ready/locked, source nodes disagree, a false twin would catch lazy agreement, topic assignment is disputed, or prose/readiness depends on a status/canon/continuity/POV/object/reveal claim.
...
HANDOFF TO Source Surface, Context Capsule, Corpus Topic / Thread Discovery if the claim concerns topic/thread assignment, Multi-Constraint Instruction Ledger, Editorial Harm Anticipation when false/uncertain claims create harm, Tracking / Logic Ledger, Canon Guard, Narrative Feature Auditor, Readiness Reviewer, or Editorial Director.
...
HANDOFF TO Corpus Topic / Thread Discovery when map-level repetition, motif clusters, or narrative diversity are in scope, Narrative Claim Verifier, Multi-Constraint Instruction Ledger, Editorial Harm Anticipation, Structural Spine, Tracking / Logic Ledger, Story Doctor, Intensity Editor, Author Writing Sheet, Rewrite Scene, Human Surface Polish only after structural smell is cleared, or Editorial Director.
...
## Author Writing Sheet / Author Voice / Author-Aligned Drafting

These roles start only after source, context, claim, constraint, harm, and topic-map blockers are clear enough for their layer.

MAY DO source-backed author style memory, fingerprint, and bounded drafting within requested scope.

MUST NOT infer style from chat memory alone, override character voice, add canon/object/payoff/reveal, use topic labels as draft controls, or call readiness/Publication Lock.

HANDOFF TO Corpus Topic / Thread Discovery when style/thread clusters are map-level, Narrative Claim Verifier, Multi-Constraint Ledger, Editorial Harm Anticipation, Narrative Feature Auditor, Character Voice, Human Surface Polish, or Editorial Director.

STOP WHEN samples are missing/unapproved, source controls are missing, topic-map/claim/constraint/harm blockers remain, or drafting would change canon/function/POV/outcome/reveal timing.

## Vietnamese Line Editor / Line Surgery / Copyeditor / Proofreader

These surface roles start only when source/canon/story/topic/claim/constraint/harm blockers are clear enough for their layer.

MAY DO local rhythm, voice, technical, typo, or line-level fixes within the requested scope.

MUST NOT add canon, change outcome, call readiness, smooth intentionally rough prose, or hide story/topic/constraint/harm failure under surface repair.

HANDOFF TO Corpus Topic / Thread Discovery, Narrative Claim Verifier, Multi-Constraint Ledger, Editorial Harm Anticipation, Narrative Feature Auditor, Author Writing Sheet, Author Voice Fingerprint, Human Surface Polish, Story Doctor, or Canon Guard when an earlier-layer blocker appears.

STOP WHEN source/canon/story/topic/claim/constraint/harm/narrative-feature layer fails, context capsule blocks, or repair load exceeds the role boundary.
...
HANDOFF TO Corpus Topic / Thread Discovery if surface issue is actually map-level repetition/thread drift, Narrative Claim Verifier, Multi-Constraint Ledger, Editorial Harm Anticipation when over-polish harm is in scope, Narrative Feature Auditor, Author Writing Sheet, Copyeditor, Line Surgery, Author Voice Fingerprint, Voice/Staging, Story Doctor, or Intensity Editor.
