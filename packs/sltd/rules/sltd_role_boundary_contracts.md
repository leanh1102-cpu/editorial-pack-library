...
Author-Aligned Drafting Assistant is bounded drafting under source, canon, POV, scene function, character voice, author writing sheet, and author fingerprint. It is not autonomous authorship.
...
HANDOFF TO Narrative Claim Verifier, Narrative Feature Auditor, Intensity Editor, Author Writing Sheet if style claim evidence matters, Author Voice Fingerprint, Author-Aligned Drafting Assistant, Vietnamese Line Editor, Line Surgery, or Editorial Director.
...
HANDOFF TO Narrative Claim Verifier, Structural Spine, Tracking / Logic Ledger, Story Doctor, Intensity Editor, Author Writing Sheet if style evidence is relevant, Rewrite Scene, Human Surface Polish only after structural smell is cleared, or Editorial Director.
...
HANDOFF TO Narrative Claim Verifier, Narrative Feature Auditor, Author Writing Sheet if style evidence controls pressure style, Author Voice Fingerprint, Author-Aligned Drafting Assistant, Vietnamese Line Editor, Line Surgery, or Story Doctor.
...
READ BEFORE approved/current author samples, AUTHOR_WORKING_PROFILE.md, AUTHOR_TASTE_EXAMPLES.md, source preflight, Narrative Claim Verification if a style claim depends on factual/status/canon evidence, Character Voice / Dialogue / Staging if character voice may be affected, and author writing sheet rule/prompt.
...
OUTPUT AUTHOR_WRITING_SHEET_READY / AUTHOR_WRITING_SHEET_NEEDS_MORE_SAMPLE / AUTHOR_SPECIFIC_RULES_READY / next node.

HANDOFF TO Author Voice Fingerprint, Author-Aligned Drafting Assistant, Character Voice / Dialogue / Staging, Human Surface Polish, or Editorial Director.
...
READ BEFORE explicit author samples or current Notion source named as sample, AUTHOR_WORKING_PROFILE.md, AUTHOR_TASTE_EXAMPLES.md, Author Writing Sheet when style claims need evidence, source preflight, author voice discipline rule, and Character Voice / Dialogue / Staging when character voice is being compared.
...
HANDOFF TO Author Writing Sheet if evidence is missing, Author-Aligned Drafting Assistant, Human Surface Polish, Narrative Feature Auditor if author-like prose is structurally AI-shaped, or Character Voice / Dialogue / Staging.
...
HANDOFF TO Narrative Claim Verifier if a draft claim is uncertain, Author Writing Sheet if style evidence is missing, Narrative Feature Auditor if draft is author-like but structurally AI-shaped, Human Surface Polish, Line Surgery, Story Doctor, or Canon Guard.

STOP WHEN exact source or scene packet is missing, context capsule blocks, claim verification blocks, author writing sheet blocks when style memory is used, narrative feature blockers remain, author sample/fingerprint is missing, or drafting would change canon/function/POV/outcome/reveal timing.
...
READ BEFORE prose rhythm, dialogue voice, anti-AI words, SLTD style, author taste, line surgery gate if needed, Author Writing Sheet / Author Voice Fingerprint if style match is in scope, Context Capsule when required.

MAY DO improve rhythm, split/reorder stiff sentences, reduce abstraction, restore body/object/silence/action, and mark need for claim verification, narrative feature audit, author writing sheet, line surgery, human surface polish, author fingerprint, or scene rewrite.
...
HANDOFF TO Narrative Claim Verifier, Narrative Feature Auditor, Author Writing Sheet, Author Voice Fingerprint, Human Surface Polish, Copyeditor, Line Surgery, or Story Doctor.
...
READ BEFORE line surgery gate, prose rhythm, dialogue voice, anti-AI words, SLTD style, author taste, Author Writing Sheet / Author Voice Fingerprint if style match is in scope, source excerpt, Context Capsule when required, Narrative Claim Verification if patch depends on a factual claim.
...
HANDOFF TO Narrative Claim Verifier, Narrative Feature Auditor, Human Surface Polish, Author Writing Sheet, Author Voice Fingerprint, Copyeditor, Rewrite Scene, or Vietnamese Line Editor.
...
HANDOFF TO Narrative Claim Verifier, Narrative Feature Auditor, Author Writing Sheet, Copyeditor, Line Surgery, Author Voice Fingerprint, Voice/Staging, Story Doctor, or Intensity Editor.

STOP WHEN exact prose source is missing, context capsule blocks, claim verification blocks, author writing sheet blocks when style memory is used, narrative feature audit blocks, repair would change canon/function/outcome/reveal timing, or repair load exceeds 30 percent.
...
READ BEFORE copyedit/proofread rule, current source, term/name/xưng hô context, Human Surface Polish result if flagged, Author Writing Sheet / Author Voice Fingerprint if style consistency is in scope, Context Capsule when required.
...
HANDOFF TO Proofreader, Human Surface Polish, Vietnamese Line Editor, Narrative Claim Verifier, Narrative Feature Auditor, or Canon Guard.
...
MUST NOT mark publication lock without current evidence, treat green prose, author-style match, claim verification, writing sheet, or narrative-feature pass as publish-ready, override human pass, or use chat memory as lock status.

HANDOFF TO Editorial Director, Narrative Claim Verifier, Story Doctor, Narrative Feature Auditor, Author Writing Sheet, Author Voice Fingerprint, Author-Aligned Drafting Assistant, Human Surface Polish, Line Surgery, or Canon Guard.
...
READ BEFORE role outputs already run, node ledger, context brief for large scope, Context Capsule when required, Narrative Claim Verification if priority depends on source/status/canon claim, Narrative Feature Audit if priority is structural AI smell, Author Writing Sheet / Author Voice / Author-Aligned Draft result if priority is style/drafting, Human Surface Polish if priority is correct-but-synthetic prose, evidence discipline, user priority.
...
Failure examples, author taste examples, author writing sheet samples, author voice samples, narrative-claim samples, narrative-feature samples, human-surface samples, and future model learning may improve recognition of patterns.
