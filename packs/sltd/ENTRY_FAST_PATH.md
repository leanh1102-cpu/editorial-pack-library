...
4. Spine Lock
5. Tracking / Logic Ledger
6. Borderbound
7. Life-Task Bound
8. Story Movement
9. Scene-First Prose Judgment
10. Narrative Feature / Structural Idiosyncrasy Audit when story-decision AI smell is in scope
11. Voice / Dialogue / Staging
12. Author Writing Sheet when claim-evidence style memory is in scope
13. Author Voice Fingerprint when author style matching is in scope
14. Draft / Rewrite / Author-Aligned Ghostwriter Draft
15. Line / Voice / Rhythm
16. Human Surface Polish
17. Composite Risk Check
18. Feedback Matrix / Report
19. Seam / Chapter Assembly
20. Readiness / Lock
```

Do not run later gears to hide failure in earlier gears. Do not draft, ghostwrite, polish, copyedit, or claim readiness before source, context capsule, claim verification, multi-constraint ledger, spine, tracking, border, narrative-feature, scene staging, author writing sheet, and author fingerprint are clear when continuity, hidden canon, object state, relationship memory, author voice, dialogue, reveal, status, lock, style evidence, task constraints, or story-decision smell is at stake. Stop at the first real blocker.
